...
async function starts() {
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("bot")){
			...
			client.updatePresence(from, Presence.composing)
			Causs = fs.readFileSync('./assets/hylander.mp3');
            client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'audio/mp4', ptt:true})
	}
			...
			client.updatePresence(from, Presence.composing)
			Causs = fs.readFileSync('./assets/akdoflamengo.mp3');
            client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'audio/mp4', ptt:true})
	}
			...
			client.updatePresence(from, Presence.composing)
			Causs = fs.readFileSync('./assets/cmgremio.mp3');
            client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'audio/mp4', ptt:true})
	}
			...
			client.updatePresence(from, Presence.composing)
			Causs = fs.readFileSync('./assets/cmflamengo.mp3');
            client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'audio/mp4', ptt:true})
	}
			...
			client.updatePresence(from, Presence.composing)
			Causs = fs.readFileSync('./assets/m4.mp3');
            client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'audio/mp4', ptt:true})
	}
			...
			client.updatePresence(from, Presence.composing)
			Causs = fs.readFileSync('./assets/macaverde.mp3');
            client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'audio/mp4', ptt:true})
	}
...
break
case 'edit1':
Causs = fs.readFileSync('./assets/edit1.mp4');
client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'video/mp4', ptt:true})
break
case 'edit2':
Causs = fs.readFileSync('./assets/edit2.mp4');
client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'video/mp4', ptt:true})
break
case 'edit3':
Causs = fs.readFileSync('./assets/edit3.mp4');
client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'video/mp4', ptt:true})
break
case 'edit4':
Causs = fs.readFileSync('./assets/edit4.mp4');
client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'video/mp4', ptt:true})
break
case 'xxx1':
Causs = fs.readFileSync('./assets/xxx1.mp4');
client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'video/mp4', ptt:true})
break
case 'xxx2':
Causs = fs.readFileSync('./assets/xxx2.mp4');
client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'video/mp4', ptt:true})
break
case 'say1':
Causs = fs.readFileSync('./assets/say1.mp4');
client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'video/mp4', ptt:true})
break
case 'say2':
Causs = fs.readFileSync('./assets/say2.mp4');
client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'video/mp4', ptt:true})
break
case 'say3':
Causs = fs.readFileSync('./assets/say3.mp4');
client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'video/mp4', ptt:true})
break
case 'say4':
Causs = fs.readFileSync('./assets/say4.mp4');
client.sendMessage(from, Causs, MessageType.audio, {quoted: msg, mimetype: 'video/mp4', ptt:true})
break
case 'akdoflamengo':
Causs = fs.readFileSync('./assets/akdoflamengo.mp3');
			...
			case 'closegp':
               ...
               if (anu.error) return reply(anu.error)
            	...
            	case 'mia':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '(hihihih)'})
					break
               case 'mia2':
					memein = await kagApi.memeindo()
               ...
               case 'belle':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '(que gostosa)'})
					break
               case 'belle2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQ7ot6RZPnXSJFFKVjPoeXHjTYyi6uk5W_mA&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '(pena que sou um robo)'})
					break
              case 'hentai':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/8U9GwX4.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '(o cara bate pra 2d kkkkk)'})
					break
		    	case 'grupoinfo':
                    client.updatePresence(from, Presence.composing)
                    if (!isGroup) return reply(mess.only.group)
